...
export default function Reports() {
  ...
  const canExport = currentUser && (currentUser.role === "admin" || currentUser.role === "superadmin");
  ...
  const exportCSV = async () => {
    ...
    if (!user || (user.role !== "admin" && user.role !== "superadmin")) {
      alert("⚠️ Export Permission Denied\n\nOnly Admins and Superadmins can export reports to CSV.\n\nYour current role: " + (user?.role || "Unknown"));
      return;
    }
  ...
  title={canExport ? "Export report as CSV" : "Only Admins and Superadmins can export"}
